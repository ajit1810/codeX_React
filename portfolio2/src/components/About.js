...
// import AboutImg from '../assets/myImage.png';
// import './About.css';
// export default function About() {
//     return (
//         <>
//             <div className="container" style={{ marginTop: "100px" }} id="about">
//                 <div className="col" style={{ textAlign: "center", color: "white", fontSize: "40px", fontWeight: "700", fontFamily: "'Lato', sans-serif" }}>About Me</div>

//                 <div className="col mt-3" style={{ color: "white ", textAlign: "center", fontSize: "20px", fontFamily: "'Lato', sans-serif", fontWeight: "300" }}>Application developer and Web development with proper ui experience</div>
//                 <div className="row mt-5">
//                     <div className="col-md-6 ">
//                         <div className="about-image ms-5 " style={{ position: "relative" }}>
//                             <img src={AboutImg} className="about-myImg" alt="My Image" />
//                         </div>
//                     </div>
//                     <div className="col-md-6 about-text" style={{ color: "rgb(149, 149, 149)", textAlign: "justify" }}>
//                         <p className="mt-4" style={{ fontSize: "16px", lineHeight: "16px" }}>
//                             Hello! I'm a software developer with 1+  year of hands-on experience, specializing in a range of technologies including Core Java, Advanced Java, Flutter, React.js, and version control with Git and GitHub.<br /><br />

//                             Flutter:<br />
//                             With practical experience in Flutter, I have built cross-platform mobile applications that ensure a smooth and engaging user experience on both iOS and Android devices. My proficiency in Dart, along with my attention to detail in mobile design principles, allows me to create visually appealing and highly functional mobile apps.<br /><br />

//                             React.js:<br />
//                             On the frontend, I have utilized React.js to develop dynamic and responsive web applications. My projects have involved creating interactive user interfaces, managing application state effectively, and employing modern JavaScript practices to enhance user experiences.<br /><br />

//                             Git & GitHub:<br />
//                             I am well-versed in using Git for version control and have a solid understanding of collaborative workflows on GitHub. This includes branching, merging, pull requests, and managing repositories, which ensures efficient and organized development processes.<br /><br />

//                             Throughout my career, I have been committed to continuous learning and adapting to new technologies. I am passionate about problem-solving, collaborating with teams, and delivering high-quality software solutions. My goal is to leverage my skills and experience to contribute to innovative projects and drive technological advancements.<br /><br />
...
//                         </p>
//                         <button type="button" className="btn about-btn-cv mt-3">Download CV</button>
